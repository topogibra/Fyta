...
<div class="container-xl ">
  ...
  <!--  -->
  <div class="row row-cols-12 justify-content-center border-bottom shopCartEntry">
    <div class="col-sm align-middle order-1">
      <img src="../assets/vaso.png" alt="" class="shopCartProduct-image">
    </div>
    <div class="col-sm align-self-center shopCartProduct-name order-2">
      <p class="mb-0">Vaso CRTF</p>
    </div>
    <div class="col-sm align-self-center shopCartProduct-per-price order-3">
      <p class="mb-0 text-right">20€</p>
    </div>
    <div class="col-sm text-center align-self-center shopCartProduct-stock order-4">
    ...
    <div class="col-sm align-self-center order-5">
      <a href="" class="shopCartProduct-trash"><i class=" fas fa-trash"></i></a>
    </div>
    <div class="col-sm align-self-center shopCartProduct-total order-6">
